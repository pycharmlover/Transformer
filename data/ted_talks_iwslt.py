...
_URL = "/home/extra_home/lc/XML_releases.tgz"
...
# Generate ALL possible language pairs automatically
# This creates 11,772 potential pairs (109 * 108)
# Only pairs with actual data in the dataset will be loaded
_LANGUAGE_PAIRS = []

# Add all possible bidirectional pairs between all languages
for src_lang in _LANGUAGES:
    for tgt_lang in _LANGUAGES:
        if src_lang != tgt_lang:
            _LANGUAGE_PAIRS.append((src_lang, tgt_lang))

print(f"📊 TED Talks: Generated {len(_LANGUAGE_PAIRS)} language pairs (all combinations)")
